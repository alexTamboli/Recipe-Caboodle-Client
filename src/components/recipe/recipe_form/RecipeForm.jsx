            ...
            <form onSubmit={handleFormSubmit}>
              <div className="shadow sm:rounded-md sm:overflow-hidden">
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  <Category category={category} setCategory={setCategory} editMode={props.editMode} recipe={props.recipe} />
                  <Ingredients
                    ...
                    recipe={props.recipe}
                  />
                  <Procedure procedures={procedures} setProcedures={setProcedures} editMode={props.editMode} recipe={props.recipe} />
                  <TimePicker setCookTime={setCookTime} editMode={props.editMode} recipe={props.recipe} />
                  <PictureUpload picture={picture} setPicture={setPicture} />
                </div>

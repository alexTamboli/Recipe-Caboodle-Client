...
const navigation = [
    { name: "Profile", icon: UserIcon, to: "/dashboard/profile", current: true },
    { name: "My Recipes", icon: MenuIcon, to: "/dashboard/myRecipes", current: false },
    {
        name: "Saved Recipes",
        icon: BookmarkIcon,
        to: "/dashboard/savedRecipes",
        current: false,
    },
];
                    ...
                    <div className="flex items-center bg-white border-b border-gray-200">
                        ...
                        <div className="flex items-center py-4 px-4 sm:px-6 lg:px-8">
                            <img
                                ...
                                src={user && user.avatar ? user.avatar : "https://res.cloudinary.com/dmtc1wlgq/image/upload/v1641911896/media/avatar/default_zrdbiq.png"}
                                alt=""
                            />
                            <div className="ml-4">
                                <h1 className="text-3xl font-bold leading-8 text-gray-900 sm:leading-9 sm:truncate">
                                    Welcome back, {user && user.username}
                                </h1>
                                <div className="flex items-center mt-1">
                                    <MailIcon className="flex-shrink-0 mr-2 h-6 w-6 text-gray-400" aria-hidden="true" />
                                    <p className="text-base text-gray-500 font-medium">{user && user.email}</p>
                                </div>
                            </div>
                        </div>
                    </div>
